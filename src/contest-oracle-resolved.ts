...
import {
  ...
  RoleGranted,
  RoleRevoked
} from "../generated/ContestOracleResolved/ContestOracleResolved"
...
export function handleChainlinkCancelled(event: ChainlinkCancelled): void {
  ...
  //
  // - contract.contestCreationTime(...)
  // - contract.contestCriteria1(...)
  // - contract.contestCriteria2(...)
  // - contract.contestId(...)
  // - contract.contests(...)
  // - contract.contestTimerInterval(...)
  // - contract.contestTimers(...)
